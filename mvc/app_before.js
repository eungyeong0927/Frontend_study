...
// 콜론(:) : 요청의 주소에서 "변수"를 사용하는 방법 (id는 변수이름 아무거나 와도 됨, ex) '/comment/:banana')
app.get("/comment/:id", (req, res) => {
    console.log(req.params); // { id: '1' }
    console.log(req.params.id); // '1' // 만약 위에서 id에 banana를 썼다면 여기도 banana

    // 댓글 id: 요청 주소로 들어온 매개변수 (:id)
    const commentId = req.params.id; // 여기도 banana
